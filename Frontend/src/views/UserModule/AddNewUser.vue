      ...
      <div class="form-sec">
        ...
        <div class="mb-3 sub-header-jobrole">
            ...
            <v-col v-if="this.$route.path == '/member/update'">
              ...
              <div class="mt-3">
                <v-radio-group v-model="user.status">
                  <v-radio label="Active" value="true" key="1"></v-radio>
                  <v-radio key="2" label="Inactive" value="false"></v-radio>
                </v-radio-group>
              </div>
            </v-col>
          </v-row>
          ...
          <div class="button-section">
            ...
            <v-btn
              v-if="this.$route.path == '/member/add'"
            ...
            <v-btn
              v-if="this.$route.path == '/member/update'"
              class="ma-2 white--text"
              style="width: 10%"
              color="red"
              @click="cancel()"
    ...
    async login() {
      ...
      if (this.$refs.form.validate()) {
        ...
        if (this.$route.path == "/member/update") {
          console.log(this.user);
          this.Isloading = true;
          const IsUpdate = await UserAPI.updateEmployee(
            this.user,
            this.user._id
          );
          if (IsUpdate) {
